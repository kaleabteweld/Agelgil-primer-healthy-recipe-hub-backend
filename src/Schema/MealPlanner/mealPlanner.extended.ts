...
// export async function update(this: mongoose.Model<IMealPlanner>, _id: string, mewMealPlanner: IMealPlannerUpdateFrom, populatePath: string | string[]): Promise<IMealPlanner | null> {

//     try {
//         const newDoc = await this.findByIdAndUpdate(_id, mewMealPlanner, { new: true, overwrite: true });
